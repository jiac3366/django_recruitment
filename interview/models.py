...
class Candidate(models.Model):
    ...
    gender = models.CharField(max_length=135, blank=True, verbose_name=u'性别') # 可以优化
    ...
    first_interviewer_user = models.ForeignKey(User, related_name='first_interviewer_user', blank=True, null=True,
                                               on_delete=models.CASCADE, verbose_name=u'面试官') # 引用成Django的用户
    ...
    second_result = models.CharField(max_length=256, choices=INTERVIEW_RESULT_TYPE, blank=True, verbose_name=u'复试结果')
    ...
    second_remark = models.CharField(max_length=135, blank=True, verbose_name=u'复试备注')

    # HR终面
    hr_score = models.CharField(max_length=10, choices=HR_SCORE_TYPE, blank=True, verbose_name=u'HR复试综合等级')
    hr_responsibility = models.CharField(max_length=10, choices=HR_SCORE_TYPE, blank=True, verbose_name=u'责任心综合等级')
    hr_communication_ability = models.CharField(max_length=10, choices=HR_SCORE_TYPE, blank=True,
                                                verbose_name=u'坦诚沟通综合等级')
    hr_logic_ability = models.CharField(max_length=10, choices=HR_SCORE_TYPE, blank=True, verbose_name=u'逻辑思维综合等级')
    hr_potential = models.CharField(max_length=10, choices=HR_SCORE_TYPE, blank=True, verbose_name=u'发展潜力综合等级')
    hr_stability = models.CharField(max_length=10, choices=HR_SCORE_TYPE, blank=True, verbose_name=u'稳定性综合等级')
    ...
    hr_result = models.CharField(max_length=256, choices=INTERVIEW_RESULT_TYPE, blank=True, verbose_name=u'HR终面结果')
    ...
    class Meta:
        ...
        permissions = [
            ...
            ("notify1", "notify1 interviewer for candidate review"),
            ("notify2", "notify2 interviewer for candidate review"),
        ]
